...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="fw-bold text-dark mb-1">Ekstrakurikuler</h2>
            <p class="text-muted mb-0">Kelola data ekstrakurikuler sekolah</p>
        </div>
        <a href="{{ route('dashboards.ekstra.manage') }}" class="btn btn-primary btn-lg shadow-sm">
            ...
            <div class="card border-0 shadow-sm h-100 hover-card">
                ...
                <div class="position-relative overflow-hidden" style="height: 250px;">
                    ...
                    <div class="position-absolute top-0 end-0 m-3">
                        <span class="badge bg-primary bg-opacity-90 px-3 py-2 rounded-pill">
                            <i class="ti ti-star me-1"></i>Ekstrakurikuler
                        </span>
                    </div>
                </div>
                ...
                <div class="card-body p-4 d-flex flex-column">
                    ...
                    <p class="text-muted mb-4 flex-grow-1" style="line-height: 1.6;">
                        {{ Str::limit($items->deskripsi, 120) }}
                    </p>

                    <!-- Action Buttons -->
                    <div class="d-flex gap-2 mt-auto">
                        <a href="{{ route('dashboards.ekstra.manage', $items->id) }}"
                           class="btn btn-outline-warning flex-fill">
                            <i class="ti ti-edit me-1"></i>Edit
                        </a>
                        <form action="{{ route('dashboards.ekstra.destroy', $items->id) }}"
                              method="POST"
